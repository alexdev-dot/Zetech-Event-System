      ...
      {location.pathname !== "/auth" && (
        ...
        <header className="sticky top-0 z-50 bg-card border-b shadow-sm">
          ...
          {mobileOpen && (
            ...
            <nav className="md:hidden border-t bg-card px-4 py-5">
                  ...
                  {link.hasDropdown ? (
                    ...
                    <div>
                      ...
                      <button
                        ...
                        className="w-full flex items-center justify-between px-5 py-5 rounded-md text-base font-medium transition-colors text-foreground hover:bg-muted min-h-[56px]"
                        ...
                        <div className="ml-4 space-y-1">
                          ...
                          {eventsDropdownItems.map((item) => (
                            ...
                            <Link
                              ...
                              className="block w-full px-5 py-4 rounded-md text-base font-medium transition-colors text-foreground hover:bg-muted min-h-[56px]"
                    ...
                    <Link
                      ...
                      className={`block w-full px-5 py-5 rounded-md text-base font-medium transition-colors min-h-[56px] ${
              ...
              {user ? (
                ...
                <div className="mt-4 pt-4 border-t flex flex-col gap-2">
                  ...
                  <Button
                    ...
                    className="w-full justify-start gap-2 min-h-[56px] text-base"
                ...
                <div className="mt-4 pt-4 border-t">
                  ...
                  <Button variant="ghost" size="default" asChild className="w-full justify-center min-h-[56px] text-base">
